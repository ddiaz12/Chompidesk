...
<div class="container mt-3">
    <div class="row justify-content-between align-items-center">
        <h3 class="col-auto">Ordenes por fecha</h3>
        <div class="col-auto">
            <td>
    ...
    <table id="myTable2" class="table table-striped table-hover">
        ...
        <tbody>
            <?php foreach ($ordenesPorFecha as $i => $dato) : ?>
                <tr>
                    <td><?= $i + 1; ?></td>
                    <td><?= $dato->id_orden; ?></td>
                    <td><?= $dato->fecha; ?></td>
                    <td><?= $dato->nombre; ?></td>
                    <td><?= $dato->estado_ord; ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
...
<div>
    <hr>
    <table id="myTable" class="table table-striped table-hover" style="display: none;">
        <thead>
            <tr>
                <td>#</td>
                <td>ID</td>
        ...
        <tbody>
            <?php foreach ($ordenesPorFechaPDF as $i => $dato) : ?>
                <tr>
                    <td><?= $i + 1; ?></td>
                    <td><?= $dato->id_orden; ?></td>
                    <td><?= $dato->fecha; ?></td>
